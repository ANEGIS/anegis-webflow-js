...
(() => {
  ...
  var PHONE_INPUT_ELEMENT = "[data-phone-input]";
  var PHONE_FEEDBACK_ELEMENT = "[data-phone-feedback]";
  ...
  // src/validations/wac-validation-email.ts
  function WACEmailValidation() {
  ...
  // src/validations/wac-validation-phone.ts
  function WACPhoneValidation() {
    ...
    function initialize() {
      ...
      const phoneInputs = document.querySelectorAll(PHONE_INPUT_ELEMENT);
      const phonePairs = /* @__PURE__ */ new Map();
      phoneInputs.forEach((input) => {
        const form = input.closest("form");
        if (!form) return;
        const feedbackElement = form.querySelector(PHONE_FEEDBACK_ELEMENT);
        if (feedbackElement) {
      ...
      function extractNineDigits(phone) {
        if (!phone) return "";
        const digits = phone.replace(/\D/g, "");
  ...
  function initializeVatValidation(container, formIndex = 0) {
    ...
    function showValidationError(message) {
      isVatValid2 = false;
      elements2.vatMessage.style.display = "flex";
...
//# sourceMappingURL=index-wac.js.map
