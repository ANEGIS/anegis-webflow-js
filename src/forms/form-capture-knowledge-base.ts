const FORM_ELEMENT = '#wf-form-knowledge-base-welcome-page-form-1234kupciazpupci';
const FORM_ID_EN = 'a5bdb8d1-0096-ef11-8a6a-000d3a66c0c2';
const FORM_ID_PL = '8bc4358c-db95-ef11-8a6a-000d3a66c0c2';
const FORM_API_URL =
